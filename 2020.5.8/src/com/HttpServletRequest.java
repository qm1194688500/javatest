...
public class HttpServletRequest {
    ...
    public static HttpServletRequest readAndParse(InputStream inputStream) throws UnsupportedEncodingException {
    ...
    private static void readAndParseRequestHeaders(HttpServletRequest request, Scanner scanner) {
        String line;
        while (true) {
    ...
    private static void readAndParseRequestLine(HttpServletRequest request, Scanner scanner) throws UnsupportedEncodingException {
    ...
    private static void parseURL(HttpServletRequest request, String url) throws UnsupportedEncodingException {
